...
This tools package contains C++ and Java implementations of the string similarity algorithms in the c++ and java sub folders of the string-similarity folder respectively. Instructions on how to use these implementations are in the README files of the c++ and java subfolders.  
